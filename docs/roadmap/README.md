...
| 31 | 미착수 | Home — two layout directions | `1d` `1e` |
| 32 | 미착수 | Writing | `1y` |
| 33 | 미착수 | Diary detail — print-page metaphors | `1i` `1j` |
| 34 | 미착수 | (33번과 같은 `1i`/`1j` 안의 사진 슬라이더·갤러리 요소 확대 참조) | `1i` `1j` |
| 35/36 | 미착수 | (하단 탭 바·설정 섹션은 별도 dv-row 없이 홈/상세 프레임 안에 포함 — 리뷰 보드에 전용 화면 없음, 043 팔레트만 상속) | — |
...
### 35. Modernist 디자인 시스템 적용 — 전역 하단 탭 바 & 설정 기본 섹션
...
- **아이디어**: `App.tsx`의 전역 하단 탭 바와 설정 탭의 상단 기본 섹션들을 Modernist 룩앤필로 이관합니다.
- **핵심 요구사항**:
  - 하단 탭 바: [일기] / [설정] / (개발자) 탭의 미니멀 텍스트/보더 레이아웃.
