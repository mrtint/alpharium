...
- **스펙**: `specs/001-project-skeleton-setup/`에 첫 기능이 있다.
- **앱 코드**: 뼈대만 있다. 환경 판정·추론 어댑터·진단까지이며, 일기 생성은 아직 없다.
...
- `src/sensors/` — 사진·GPS·걸음 수·배터리 등 기기 신호 수집
- `src/diary/` — 일기 생성
