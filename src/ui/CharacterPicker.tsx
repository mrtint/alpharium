 ...
 *
 * 006까지 `App.tsx`가 준비된 것 중 **먼저 나오는 하나를 말없이 집었다.** 여럿을 다
 ...
 *
 * **추천하거나 미리 고르지 않는다**(FR-008). 로스터의 캐릭터가 같은 자격으로 보인다.
 * ─────────────────────────────────────────────────────────────────────────────
 */
...
export function CharacterPicker({ characters, selected, onSelect }: CharacterPickerProps) {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* 로스터의 자리가 **처음부터 전부** 보인다(003 FR-005a). 고를 대상이 보이지 않으면 고를 수 없다 */}
