...
- [x] **사진이 있는 하루는 VLM을 반드시 거친다** (042 — 「보지 않음」·「자세히 봄」 제거, 백그라운드·진단 경로까지 항상 캡션. 헌법 v1.7.0 선행 개정. **실기기 검증 미수행**)
...
- **구현 결과 (042, 2026-09-14)**: `VisionSetting`을 `"quick"` 하나로 좁히니 `tsc`가
  ...
  **실기기 검증(D1~D7)은 미수행** — 특히 D5(백그라운드)가 이 기능의 실질이다.
  상세: `specs/042-photo-vision-always/`.
